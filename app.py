...
# ============================================================
# LOAD DEEP MODELS (PRETRAINED)
# ============================================================
@st.cache_resource
def load_dl_models():
    cnn = load_model("cnn_model.h5")
    cnn_vit = load_model("cnn_vit_model.h5")
    return cnn, cnn_vit

if uploaded_file is not None:

    # ============================================================
    # IMAGE PROCESSING (MATCH COLAB)
    # ============================================================
    ...
    # ============================================================
    # COLONY DETECTION & FEATURE EXTRACTION
    # ============================================================
    for cnt in contours:
        ...
        colony_data.append([
            area, perimeter, circularity, health_class
        ])
